{ config, lib, pkgs, ... }:
{
  wayland.windowManager.hyprland.settings = {
    ...
    bind = [
      ...
      "CTRL SHIFT, 1, exec, bash /home/${uservars.name}/.scripts/eww_ws.sh"
      "CTRL SHIFT, 2, movetoworkspace, 2"
      "CTRL SHIFT, 2, exec, bash /home/${uservars.name}/.scripts/eww_ws.sh"
      "CTRL SHIFT, 3, movetoworkspace, 3"
      "CTRL SHIFT, 3, exec, bash /home/${uservars.name}/.scripts/eww_ws.sh"
      "CTRL SHIFT, 4, movetoworkspace, 4"
      "CTRL SHIFT, 4, exec, bash /home/${uservars.name}/.scripts/eww_ws.sh"
      "CTRL SHIFT, 5, movetoworkspace, 5"
      "CTRL SHIFT, 5, exec, bash /home/${uservars.name}/.scripts/eww_ws.sh"
      "CTRL SHIFT, 6, movetoworkspace, 6"
      "CTRL SHIFT, 6, exec, bash /home/${uservars.name}/.scripts/eww_ws.sh"
      "CTRL SHIFT, 7, movetoworkspace, 7"
      "CTRL SHIFT, 7, exec, bash /home/${uservars.name}/.scripts/eww_ws.sh"
      "CTRL SHIFT, 8, movetoworkspace, 8"
      "CTRL SHIFT, 8, exec, bash /home/${uservars.name}/.scripts/eww_ws.sh"
      "CTRL SHIFT, 9, movetoworkspace, 9"
      "CTRL SHIFT, 9, exec, bash /home/${uservars.name}/.scripts/eww_ws.sh"
      "CTRL SHIFT, 0, movetoworkspace, 10"
      "CTRL SHIFT, 0, exec, bash /home/${uservars.name}/.scripts/eww_ws.sh"
      "CTRL SHIFT, right, movetoworkspace, e+1"
      "CTRL SHIFT, right, exec, bash /home/${uservars.name}/.scripts/eww_ws.sh"
      "CTRL SHIFT, left, movetoworkspace, e-1"
      "CTRL SHIFT, left, exec, bash /home/${uservars.name}/.scripts/eww_ws.sh"
      #launchers
