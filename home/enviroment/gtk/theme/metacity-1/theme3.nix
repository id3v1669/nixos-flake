...
{
  home.file.".themes/dynamic-color-theme/metacity-1/metacity-theme-3.xml".text = ''
<?xml version="1.0"?>
<metacity_theme>
  <info>
  ...
  <constant name="C_background" value="gtk:bg[NORMAL]" />
  ...
  <frame_geometry name="normal_unfocused" title_scale="medium" rounded_top_left="10" rounded_top_right="10" parent="normal" />
  ...
  <frame_geometry name="border" has_title="false" rounded_top_left="8" rounded_top_right="8" parent="normal">
    <distance name="left_width" value="1" />
    <distance name="right_width" value="1" />
  ...
  <frame_geometry name="borderless" has_title="false" rounded_top_left="8" rounded_top_right="8" parent="normal">
    <distance name="left_width" value="0" />
    <distance name="right_width" value="0" />
    <distance name="bottom_height" value="0" />
    <distance name="title_vertical_pad" value="0" />
  ...
  <frame_geometry name="modal" title_scale="small" hide_buttons="true" rounded_top_left="8" rounded_top_right="8" rounded_bottom_right="false" rounded_bottom_left="false" parent="small"></frame_geometry>

  <frame_geometry name="attached" title_scale="small" hide_buttons="true" rounded_top_left="8" rounded_top_right="8" parent="small"></frame_geometry>

  <!-- ::: TITLES ::: -->
  <draw_ops name="title_focused">
    <title version="< 3.1" x="(0 `max` ((width - title_width) / 2)) + 2" y="(0 `max` ((height - title_height) / 2)) + 1" color="C_title_focused_shadow" />
    <title version="< 3.1" x="(0 `max` ((width - title_width) / 2)) + 2" y="(0 `max` ((height - title_height) / 2))" color="C_title_focused" />
    <title version=">= 3.1" x="(0 `max` ((frame_x_center - title_width/2) `min` (width - title_width))) + 2" y="(0 `max` ((height - title_height) / 2)) + 1" ellipsize_width="width" color="C_title_focused_shadow" />
    <title version=">= 3.1" x="(0 `max` ((frame_x_center - title_width/2) `min` (width - title_width))) + 2" y="(0 `max` ((height - title_height) / 2))" ellipsize_width="width" color="C_title_focused" />
  </draw_ops>

  <draw_ops name="title_unfocused">
    <title version="< 3.1" x="(0 `max` ((width - title_width) / 2)) + 2" y="(0 `max` ((height - title_height) / 2)) + 1" color="C_title_unfocused_shadow" />
    <title version="< 3.1" x="(0 `max` ((width - title_width) / 2)) + 2" y="(0 `max` ((height - title_height) / 2))" color="C_title_unfocused" />
    <title version=">= 3.1" x="(0 `max` ((frame_x_center - title_width/2) `min` (width - title_width))) + 2" y="(0 `max` ((height - title_height) / 2)) + 1" ellipsize_width="width" color="C_title_unfocused_shadow" />
    <title version=">= 3.1" x="(0 `max` ((frame_x_center - title_width/2) `min` (width - title_width))) + 2" y="(0 `max` ((height - title_height) / 2))" ellipsize_width="width" color="C_title_unfocused" />
  </draw_ops>

  <!-- ::: WINDOW DECORATIONS ::: -->
  <draw_ops name="entire_background_focused">
    <rectangle color="C_titlebar_gradient_b" x="0" y="0" width="width" height="height" filled="true" />
  </draw_ops>
  ...
  <draw_ops name="titlebar_fill_focused">
    <gradient type="vertical" x="0" y="0" width="width" height="title_height">
      <color value="C_titlebar_gradient_a" />
      <color value="C_titlebar_gradient_b" />
    </gradient>
  </draw_ops>
  ...
  <draw_ops name="dialog_fill_background">
    <rectangle color="C_background" x="0" y="0" width="width" height="height" filled="true" />
  </draw_ops>

  <draw_ops name="dialog_background">
    <rectangle color="C_background" x="0" y="0" width="width" height="height" filled="true" />
  </draw_ops>
  ...
  <frame_style name="dialog_focused" geometry="nobuttons">
    <piece position="entire_background" draw_ops="dialog_background" />
    <piece position="titlebar" draw_ops="dialog_fill_background" />
    <piece position="title" draw_ops="title_focused" />
    <piece position="overlay" draw_ops="rounded_border_focused" />
    <button function="close" state="normal" draw_ops="close_focused" />
    <button function="close" state="prelight" draw_ops="close_focused_prelight" />
