{config, lib, pkgs, ...}:
{
  home.file.".themes/dynamic-color-theme/gtk-2.0/gtkrc".text = ''
  # Oomox GTK Theme (Numix Fork)

gtk-color-scheme =
"base_color:#${config.colorScheme.colors.base00}\nbg_color:#${config.colorScheme.colors.base00}\ntooltip_bg_color:#${config.colorScheme.colors.base00}\nselected_bg_color:#${config.colorScheme.colors.base02}\ntext_color:#${config.colorScheme.colors.base06}\nfg_color:#${config.colorScheme.colors.base06}\ntooltip_fg_color:#${config.colorScheme.colors.base06}\nselected_fg_color:#${config.colorScheme.colors.base07}\nmenubar_bg_color:#${config.colorScheme.colors.base00}\nmenubar_fg_color:#${config.colorScheme.colors.base06}\ntoolbar_bg_color:#${config.colorScheme.colors.base00}\ntoolbar_fg_color:#${config.colorScheme.colors.base06}\nmenu_bg_color:#${config.colorScheme.colors.base00}\nmenu_fg_color:#${config.colorScheme.colors.base06}\npanel_bg_color:#${config.colorScheme.colors.base00}\npanel_fg_color:#${config.colorScheme.colors.base06}\nlink_color:#6a06cd\nbtn_bg_color:#${config.colorScheme.colors.base00}\nbtn_fg_color:#${config.colorScheme.colors.base06}\ntitlebar_bg_color:#${config.colorScheme.colors.base00}\ntitlebar_fg_color:#${config.colorScheme.colors.base06}\nprimary_caret_color:#${config.colorScheme.colors.base06}\nsecondary_caret_color:#${config.colorScheme.colors.base06}\naccent_bg_color:#${config.colorScheme.colors.base08}\n"
# Default Style
