...
#LookingGlassDialog .notebook-tab:selected {
  border-color: transparent;
  background-color: rgba(242, 213, 207, 0.12);
  box-shadow: inset 0 -2px 0 #eebebe;
  color: #f2d5cf;
  text-shadow: none;
}
...
.osd-window .level {
  ...
  -barlevel-active-background-color: #f2d5cf;
  -barlevel-overdrive-color: #e78284;
...
#panel .panel-button:hover {
  color: #ef9f76;
  background-color: transparent;
  box-shadow: inset 0 0 0 1000px #414559;
}
...
#panel .panel-button:checked:hover {
  background-color: transparent;
  color: #ef9f76;
  box-shadow: inset 0 0 0 1000px #51576d;
}
...
.slider {
  ...
  -slider-border-color: #ef9f76;
  -slider-active-background-color: #ef9f76;
  -slider-active-border-color: #ef9f76;
  ...
  -barlevel-active-background-color: #ef9f76;
