...
:root {
	...
	--ctp-frappe-flamingo: #${config.colorScheme.colors.base0F};
	--ctp-frappe-pink: #${config.colorScheme.colors.base0F};
	--ctp-frappe-mauve: #${config.colorScheme.colors.base0E};
	--ctp-frappe-red: #${config.colorScheme.colors.base08};
	--ctp-frappe-maroon: #${config.colorScheme.colors.base0F};
	--ctp-frappe-peach: #${config.colorScheme.colors.base09};
	--ctp-frappe-yellow: #${config.colorScheme.colors.base0A};
	--ctp-frappe-green: #${config.colorScheme.colors.base0B};
	--ctp-frappe-teal: #${config.colorScheme.colors.base0C};
	--ctp-frappe-sky: #${config.colorScheme.colors.base05};
	--ctp-frappe-sapphire: #${config.colorScheme.colors.base05};
	--ctp-frappe-blue: #${config.colorScheme.colors.base0D};
	--ctp-frappe-lavender: #${config.colorScheme.colors.base07};
	--ctp-frappe-text: #${config.colorScheme.colors.base05};
	--ctp-frappe-subtext1: #${config.colorScheme.colors.base05};
	--ctp-frappe-subtext0: #${config.colorScheme.colors.base07};
	--ctp-frappe-overlay2: #${config.colorScheme.colors.base07};
	--ctp-frappe-overlay1: #${config.colorScheme.colors.base04};
	--ctp-frappe-overlay0: #${config.colorScheme.colors.base04};
	--ctp-frappe-surface2: #${config.colorScheme.colors.base04};
	--ctp-frappe-surface1: #${config.colorScheme.colors.base03};
	--ctp-frappe-surface0: #${config.colorScheme.colors.base02};
	--ctp-frappe-base: #${config.colorScheme.colors.base00};
	--ctp-frappe-mantle: #${config.colorScheme.colors.base01};
	--ctp-frappe-crust: #${config.colorScheme.colors.base01};
